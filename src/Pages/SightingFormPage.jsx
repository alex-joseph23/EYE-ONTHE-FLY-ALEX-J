  ...
  setAddress(event.target.value);
    ...
    function handleSubmit(event) {
        event.preventDefault();
          ...
          setSuccessMessage("");
          setCheckboxError("");
          if (!isChecked) { setCheckboxError("Confirm your sighting before submitting")
            return;
          }
        if (address === "") {
      ...
      .then((data) => {
        ...
        setSightingsByCounty((prev) => ({ ...prev,
            [countyWithSuffix]: (prev[countyWithSuffix] || 0) + 1
        }));
        setAddress("");
        setSuccessMessage("Thank you! Your sighting was succesfully sumbitted to our tracker.")
        setErrorMessage("");
      })
     .catch((error) => {
