...
const lifecycleImages = [
    { src:"/assets/winter.jpg", alt:"Spotted Lanternfly white egg mass on a tree in winter"},
    {src: "/assets/spring.jpg", alt: "Black Spotted LanternFly nymph with white spots in spring"},
    {src:"/assets/summer.jpg", alt:"Red and black Spotted Lanternfly nymph with white spots in summer"},
    {src:"/assets/fall.jpg", alt:"Adult Spotted Lanternfly that has black spots on their tan wings"},
];
function HomePage() {
    return (
            ...
            <div className="home-info">
                ...
                <div className="mission-statement">
                    ...
                    <p>
                        ...
                        to come together to track and combat the increasing spread of the invasive
                        species known as the Spotted Lanternfly (<em>Lycorma Delicatula</em>).</p>
                        <p>
                        Track user submissions throughout the map on the map page or submit your own sightings on the submissions page.
                        </p>
                    </div>
                </div>
                </section> ); }
